...
if __name__ == '__main__':
 ...
 # every time we make a change to our python code, it will automatically re run the webserver. we will turn that off during production, but we dont want to manually re run the web server.